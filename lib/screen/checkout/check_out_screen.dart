...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  late InvoiceCreate invoiceCreate = InvoiceCreate.empty();
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> checkout(InvoiceCreate invoice) async {
      ...
      if (momoResponse.resultCode == 0) {
        ...
        invoiceCreate = InvoiceCreate.empty();
      } else {
        PopupUtil.showError(context: context, message: response.message, width: SizeConfig.screenWidth * 0.4);
      }
    }
